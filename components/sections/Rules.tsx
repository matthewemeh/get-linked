...
const Rules = () => {
  return (
    <section className='relative h-[620px] pb-7 pl-[12.8vw] pr-[5.6vw] flex items-center justify-between border-b border-[rgba(255,255,255,0.18)]'>
      <Image
        alt=''
        priority
        width={26}
        ...
        className='absolute top-[405px] left-[51.5vw] -z-1'
      />
      ...
      <div className='max-w-[519.5px]'>
        <h3 className='font-clash-display text-[32px] font-bold'>
          Rules and
